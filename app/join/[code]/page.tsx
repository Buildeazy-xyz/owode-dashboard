      ...
      <div className="w-full max-w-md text-center">
        ...
        <div className="bg-white rounded-3xl p-8 shadow-2xl">
          ...
          <p className="text-gray-500 text-sm mb-6">
            Someone has invited you to join their Ajo savings group on OWODE Alajo.
          </p>
          ...
          <div className="bg-blue-50 rounded-2xl p-5 mb-6">
            ...
            href="https://play.google.com/store/apps/details?id=com.owode.alajo.app"
            className="block w-full bg-blue-800 text-white rounded-xl p-4 font-bold hover:bg-blue-900 transition"
          >
            Get OWODE Alajo
          </a>

          <p className="text-gray-400 text-xs mt-5 leading-relaxed">
            Already have the app? Open it, go to Ajo, tap &quot;Have an invite code?&quot;
            and enter <span className="font-bold text-gray-600">{clean}</span>.
          </p>
        </div>

        <p className="text-blue-300 text-xs mt-6 leading-relaxed px-4">
          Standard Ajo groups are between people who know each other.
