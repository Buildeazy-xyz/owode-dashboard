...
export default function DashboardPage() {
  ...
  const statCards = [
    ...
    { label: 'Standard Ajo', value: (stats?.totalGroups || 0) - (stats?.guaranteedGroups || 0), icon: '🤝', color: 'bg-green-50 border-green-200', textColor: 'text-green-800' },
    { label: 'Guaranteed Ajo', value: stats?.guaranteedGroups || 0, icon: '🛡️', color: 'bg-purple-50 border-purple-200', textColor: 'text-purple-800' },
    ...
    { label: 'Transactions', value: stats?.totalTransactions || 0, icon: '💳', color: 'bg-indigo-50 border-indigo-200', textColor: 'text-indigo-800' },
  ...
  return (
    <div>
      <div className="mb-8 flex items-center justify-between">
        ...
        <button onClick={loadStats} className="bg-blue-800 text-white px-4 py-2 rounded-xl text-sm font-semibold hover:bg-blue-900 transition">
          🔄 Refresh
        </button>
      </div>
