...
export const adminAPI = {
  ...
  getPendingAjo: () => api.get('/user-ajo/admin/pending'),
  approveAjo: (groupId: string) => api.post(`/user-ajo/admin/approve/${groupId}`),
  rejectAjo: (groupId: string, reason: string) => api.post(`/user-ajo/admin/reject/${groupId}`, { reason }),
